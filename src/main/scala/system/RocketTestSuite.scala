...
object DefaultTestSuites {
  ...
  val rv64uiNames = LinkedHashSet("addw", "addiw", "ld", "lwu", "sd", "slliw", "sllw", "sltiu", "sltu", "sraiw", "sraw", "srliw", "srlw", "subw", "eaddi", "eaddie", "eaddix", "eld", "elw", "elh", "elhu", "elb", "elbu", "ele", "esd", "esw", "esh", "esb", "ese", "erld", "erlw", "erlh", "erlhu", "erlb", "erlbu", "erle", "ersd", "ersw", "ersh", "ersb", "erse")
