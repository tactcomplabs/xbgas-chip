...
object Instructions {
  ...
  def EADDIE             = BitPat("b?????????????????111?????1111011")
  ...
  def ERLE               = BitPat("b0100001??????????100?????0110011")
  ...
  def ERSE               = BitPat("b0100011??????????011?????0110011")
  ...
  def ESE                = BitPat("b?????????????????101?????1111011")
  def ESH                = BitPat("b?????????????????001?????1111011")
  def ESQ                = BitPat("b?????????????????100?????1111011")
