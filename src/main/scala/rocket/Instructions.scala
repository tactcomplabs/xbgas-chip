...
/* make EXTENSIONS="unratified/rv_zxbgas rv_* rv64*" inst.chisel */
...
object Instructions {
  ...
  //ZXBGAS
  def EADDI              = BitPat("b?????????????????110?????1111011")
  def EADDIE             = BitPat("b?????????????????101?????1111011")
  def EADDIX             = BitPat("b?????????????????111?????0000011")
  def ELB                = BitPat("b?????????????????000?????1110111")
  def ELBU               = BitPat("b?????????????????100?????1110111")
  def ELD                = BitPat("b?????????????????011?????1110111")
  def ELE                = BitPat("b?????????????????111?????1110111")
  def ELH                = BitPat("b?????????????????001?????1110111")
  def ELHU               = BitPat("b?????????????????101?????1110111")
  def ELW                = BitPat("b?????????????????010?????1110111")
  def ERLB               = BitPat("b1010101??????????000?????0110011")
  def ERLBU              = BitPat("b1010101??????????100?????0110011")
  def ERLD               = BitPat("b1010101??????????011?????0110011")
  def ERLE               = BitPat("b1010101??????????111?????0110011")
  def ERLH               = BitPat("b1010101??????????001?????0110011")
  def ERLHU              = BitPat("b1010101??????????101?????0110011")
  def ERLW               = BitPat("b1010101??????????010?????0110011")
  def ERSB               = BitPat("b0100010??????????000?????0110011")
  def ERSD               = BitPat("b0100010??????????011?????0110011")
  def ERSE               = BitPat("b0100010??????????111?????0110011")
  def ERSH               = BitPat("b0100010??????????001?????0110011")
  def ERSW               = BitPat("b0100010??????????010?????0110011")
  def ESB                = BitPat("b?????????????????000?????1111011")
  def ESD                = BitPat("b?????????????????011?????1111011")
  def ESE                = BitPat("b?????????????????111?????1111011")
  def ESH                = BitPat("b?????????????????001?????1111011")
  def ESW                = BitPat("b?????????????????010?????1111011")
  def MOVEBE             = BitPat("b?????????????????110?????1111011")
  def MOVEEB             = BitPat("b?????????????????111?????1111011")
  def MOVEEE             = BitPat("b?????????????????111?????0000011")
}
object Causes {
