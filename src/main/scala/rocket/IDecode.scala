...
class ZXBGASDecode(aluFn: ALUFN = ALUFN())(implicit val p: Parameters) extends DecodeConstants {
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    ELD->         List(Y,N,Y,N,N,N,N,Y,N,N,N,N,A2_ZERO,A1_RS1, IMM_I, DW_XPR,aluFn.FN_ADD,   N,M_XRD,    N,N,N,N,N,N,Y,CSR.N,N,N,N,N,EDP_MEM),
    ESD->         List(Y,N,Y,N,N,N,Y,Y,N,N,N,N,A2_ZERO,A1_RS1, IMM_S, DW_XPR,aluFn.FN_ADD,   N,M_XWR,    N,N,N,N,N,N,N,CSR.N,N,N,N,N,EDP_MEM),
